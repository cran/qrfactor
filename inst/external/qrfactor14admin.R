...
rq <- function(source,layer='',var='',type='',predict="Yes",scale="sd",transform='',nfactors=2,match="",matchfile="",...)
{
#read data
...
#generic function
qrfactor<-function(source,layer='',var='',type='',predict="",scale="",transform="",nfactors=2,match="",matchfile="",...) UseMethod ("qrfactor")

#default function
qrfactor.default<-function(source,layer='',var='',type='',predict="yes",scale="",transform="",nfactors=2,match="",matchfile="",...)
{
